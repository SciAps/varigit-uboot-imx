...
static const char *imx8mp_mipi_dsi_esc_rx_sels[] = {"clock-osc-24m", "sys_pll2_100m", "sys_pll1_80m",
...
static int imx8mp_clk_probe(struct udevice *dev)
{
	...
	clk_dm(IMX8MP_CLK_MIPI_DSI_ESC_RX, imx8m_clk_composite("mipi_dsi_esc_rx", imx8mp_mipi_dsi_esc_rx_sels, base + 0x9200));
